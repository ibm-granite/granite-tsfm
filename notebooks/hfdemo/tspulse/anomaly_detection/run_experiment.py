...
from torch import multiprocessing as mpc
import matplotlib.pyplot as plt
from collections import defaultdict
from sklearn.preprocessing import MinMaxScaler
from utility.metrics import get_metrics, find_length_rank
...
def run_tsad_pipeline(data,
    ...
    clf = TSAD_Pipeline(num_input_channels=num_input_channels,
...
def process_file(filename, args):
    ...
    try:
        ...
        extra_kwargs = {}
        extra_kwargs.update(num_input_channels=in_channels,
