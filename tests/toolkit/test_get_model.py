...
test_cases_r3_generic = [
    ...
    (1024, 96, None, False, False, "1024-96-dec-1024-r3"),
    (1024, 720, None, False, False, "1024-720-dec-1024-r3"),
    (1536, 96, None, False, False, "1536-96-dec-1536-r3"),
    (1536, 720, None, False, False, "1536-720-dec-1536-r3"),
    ...
    (1024, 96, None, False, True, "1024-96-dec-1024-lite-r3"),
    (1024, 720, None, False, True, "1024-720-dec-1024-lite-r3"),
    (1536, 96, None, False, True, "1536-96-dec-1536-lite-r3"),
    (1536, 720, None, False, True, "1536-720-dec-1536-lite-r3"),
...
test_cases_r3_hybrid_fallback = [
    ...
    (1024, 96, None, False, "1024-96-dec-1024-r3"),
    (1024, 720, None, False, "1024-720-dec-1024-r3"),
