...
class FlowStateFunctionalTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.constant_data = cls.constant_data if cls.params["batch_first"] else torch.transpose(cls.constant_data, 1, 0)
        ...
        # )
        cls.embed_output = torch.tensor([[[0.6146, 0.1323, 0.5224, 0.0958, 0.3410],
        ...
        #     cls.params["encoder_state_dim"],
        # )]
        cls.enc_output_hidden_states = [torch.tensor([[[ 1.3950,  1.2677,  0.3756,  0.0789, -1.4111],
         [ 1.3950,  1.2677,  0.3756,  0.0789, -1.4111]],

        [[ 1.4152,  1.2659,  0.3814,  0.0466, -1.4031],
         [ 1.4152,  1.2659,  0.3814,  0.0466, -1.4031]],

        [[ 1.4319,  1.2655,  0.3874,  0.0164, -1.3951],
         [ 1.4319,  1.2655,  0.3874,  0.0164, -1.3951]],

        [[ 1.4405,  1.2690,  0.3947, -0.0102, -1.3879],
         [ 1.4405,  1.2690,  0.3947, -0.0102, -1.3879]],

        [[ 1.4488,  1.2722,  0.4015, -0.0357, -1.3806],
         [ 1.4488,  1.2722,  0.4015, -0.0357, -1.3806]],

        [[ 1.4568,  1.2752,  0.4077, -0.0603, -1.3732],
         [ 1.4568,  1.2752,  0.4077, -0.0603, -1.3732]],

        [[ 1.4644,  1.2779,  0.4133, -0.0838, -1.3657],
         [ 1.4644,  1.2779,  0.4133, -0.0838, -1.3657]],

        [[ 1.4716,  1.2805,  0.4185, -0.1063, -1.3582],
         [ 1.4716,  1.2805,  0.4185, -0.1063, -1.3582]],

        [[ 1.4785,  1.2830,  0.4231, -0.1278, -1.3507],
         [ 1.4785,  1.2830,  0.4231, -0.1278, -1.3507]],

        [[ 1.4850,  1.2853,  0.4273, -0.1484, -1.3432],
         [ 1.4850,  1.2853,  0.4273, -0.1484, -1.3432]],

        [[ 1.4913,  1.2875,  0.4310, -0.1679, -1.3358],
         [ 1.4913,  1.2875,  0.4310, -0.1679, -1.3358]],

        [[ 1.4971,  1.2897,  0.4342, -0.1866, -1.3284],
         [ 1.4971,  1.2897,  0.4342, -0.1866, -1.3284]],

        [[ 1.5026,  1.2918,  0.4371, -0.2044, -1.3210],
         [ 1.5026,  1.2918,  0.4371, -0.2044, -1.3210]],

        [[ 1.5078,  1.2939,  0.4395, -0.2213, -1.3138],
         [ 1.5078,  1.2939,  0.4395, -0.2213, -1.3138]],

        [[ 1.5127,  1.2959,  0.4415, -0.2373, -1.3067],
         [ 1.5127,  1.2959,  0.4415, -0.2373, -1.3067]],

        [[ 1.5173,  1.2980,  0.4432, -0.2526, -1.2997],
         [ 1.5173,  1.2980,  0.4432, -0.2526, -1.2997]],

        [[ 1.5215,  1.3001,  0.4445, -0.2671, -1.2929],
         [ 1.5215,  1.3001,  0.4445, -0.2671, -1.2929]],

        [[ 1.5255,  1.3021,  0.4454, -0.2808, -1.2861],
         [ 1.5255,  1.3021,  0.4454, -0.2808, -1.2861]],

        [[ 1.5291,  1.3043,  0.4461, -0.2939, -1.2795],
         [ 1.5291,  1.3043,  0.4461, -0.2939, -1.2795]],

        [[ 1.5325,  1.3065,  0.4464, -0.3062, -1.2730],
         [ 1.5325,  1.3065,  0.4464, -0.3062, -1.2730]],

        [[ 1.5355,  1.3087,  0.4465, -0.3180, -1.2667],
         [ 1.5355,  1.3087,  0.4465, -0.3180, -1.2667]],

        [[ 1.5383,  1.3110,  0.4463, -0.3291, -1.2605],
         [ 1.5383,  1.3110,  0.4463, -0.3291, -1.2605]],

        [[ 1.5408,  1.3134,  0.4458, -0.3396, -1.2545],
         [ 1.5408,  1.3134,  0.4458, -0.3396, -1.2545]],

        [[ 1.5431,  1.3159,  0.4452, -0.3495, -1.2485],
         [ 1.5431,  1.3159,  0.4452, -0.3495, -1.2485]],

        [[ 1.5450,  1.3185,  0.4442, -0.3589, -1.2428],
         [ 1.5450,  1.3185,  0.4442, -0.3589, -1.2428]],

        [[ 1.5467,  1.3212,  0.4431, -0.3678, -1.2371],
         [ 1.5467,  1.3212,  0.4431, -0.3678, -1.2371]],

        [[ 1.5482,  1.3240,  0.4418, -0.3762, -1.2316],
         [ 1.5482,  1.3240,  0.4418, -0.3762, -1.2316]],

        [[ 1.5493,  1.3269,  0.4403, -0.3842, -1.2262],
         [ 1.5493,  1.3269,  0.4403, -0.3842, -1.2262]],

        [[ 1.5503,  1.3299,  0.4386, -0.3917, -1.2209],
         [ 1.5503,  1.3299,  0.4386, -0.3917, -1.2209]],

        [[ 1.5510,  1.3330,  0.4368, -0.3988, -1.2158],
         [ 1.5510,  1.3330,  0.4368, -0.3988, -1.2158]],

        [[ 1.5514,  1.3362,  0.4348, -0.4056, -1.2108],
         [ 1.5514,  1.3362,  0.4348, -0.4056, -1.2108]],

        [[ 1.5516,  1.3396,  0.4326, -0.4119, -1.2058],
         [ 1.5516,  1.3396,  0.4326, -0.4119, -1.2058]],

        [[ 1.5516,  1.3430,  0.4304, -0.4179, -1.2010],
         [ 1.5516,  1.3430,  0.4304, -0.4179, -1.2010]],

        [[ 1.5514,  1.3466,  0.4280, -0.4236, -1.1963],
         [ 1.5514,  1.3466,  0.4280, -0.4236, -1.1963]],

        [[ 1.5509,  1.3503,  0.4255, -0.4290, -1.1916],
         [ 1.5509,  1.3503,  0.4255, -0.4290, -1.1916]],

        [[ 1.5502,  1.3542,  0.4229, -0.4341, -1.1871],
         [ 1.5502,  1.3542,  0.4229, -0.4341, -1.1871]]]),
        
        torch.tensor([[[ 1.9439,  2.8983, -0.2151, -0.2526, -2.6684],
         [ 1.9439,  2.8983, -0.2151, -0.2526, -2.6684]],

        [[ 1.9769,  2.8930, -0.2087, -0.2995, -2.6556],
         [ 1.9769,  2.8930, -0.2087, -0.2995, -2.6556]],

        [[ 2.0047,  2.8903, -0.2012, -0.3460, -2.6416],
         [ 2.0047,  2.8903, -0.2012, -0.3460, -2.6416]],

        [[ 2.0194,  2.8948, -0.1911, -0.3908, -2.6262],
         [ 2.0194,  2.8948, -0.1911, -0.3908, -2.6262]],

        [[ 2.0333,  2.8988, -0.1820, -0.4331, -2.6110],
         [ 2.0333,  2.8988, -0.1820, -0.4331, -2.6110]],

        [[ 2.0466,  2.9024, -0.1737, -0.4733, -2.5961],
         [ 2.0466,  2.9024, -0.1737, -0.4733, -2.5961]],

        [[ 2.0593,  2.9057, -0.1662, -0.5112, -2.5814],
         [ 2.0593,  2.9057, -0.1662, -0.5112, -2.5814]],

        [[ 2.0713,  2.9085, -0.1595, -0.5471, -2.5671],
         [ 2.0713,  2.9085, -0.1595, -0.5471, -2.5671]],

        [[ 2.0827,  2.9111, -0.1535, -0.5811, -2.5532],
         [ 2.0827,  2.9111, -0.1535, -0.5811, -2.5532]],

        [[ 2.0936,  2.9135, -0.1482, -0.6131, -2.5396],
         [ 2.0936,  2.9135, -0.1482, -0.6131, -2.5396]],

        [[ 2.1040,  2.9156, -0.1436, -0.6435, -2.5264],
         [ 2.1040,  2.9156, -0.1436, -0.6435, -2.5264]],

        [[ 2.1138,  2.9175, -0.1396, -0.6721, -2.5136],
         [ 2.1138,  2.9175, -0.1396, -0.6721, -2.5136]],

        [[ 2.1232,  2.9193, -0.1361, -0.6992, -2.5012],
         [ 2.1232,  2.9193, -0.1361, -0.6992, -2.5012]],

        [[ 2.1322,  2.9209, -0.1331, -0.7247, -2.4892],
         [ 2.1322,  2.9209, -0.1331, -0.7247, -2.4892]],

        [[ 2.1407,  2.9225, -0.1306, -0.7489, -2.4776],
         [ 2.1407,  2.9225, -0.1306, -0.7489, -2.4776]],

        [[ 2.1488,  2.9239, -0.1285, -0.7717, -2.4665],
         [ 2.1488,  2.9239, -0.1285, -0.7717, -2.4665]],

        [[ 2.1566,  2.9252, -0.1267, -0.7933, -2.4557],
         [ 2.1566,  2.9252, -0.1267, -0.7933, -2.4557]],

        [[ 2.1639,  2.9265, -0.1252, -0.8136, -2.4455],
         [ 2.1639,  2.9265, -0.1252, -0.8136, -2.4455]],

        [[ 2.1709,  2.9278, -0.1240, -0.8329, -2.4357],
         [ 2.1709,  2.9278, -0.1240, -0.8329, -2.4357]],

        [[ 2.1775,  2.9291, -0.1231, -0.8511, -2.4263],
         [ 2.1775,  2.9291, -0.1231, -0.8511, -2.4263]],

        [[ 2.1837,  2.9303, -0.1223, -0.8682, -2.4174],
         [ 2.1837,  2.9303, -0.1223, -0.8682, -2.4174]],

        [[ 2.1896,  2.9315, -0.1217, -0.8844, -2.4089],
         [ 2.1896,  2.9315, -0.1217, -0.8844, -2.4089]],

        [[ 2.1951,  2.9328, -0.1212, -0.8997, -2.4008],
         [ 2.1951,  2.9328, -0.1212, -0.8997, -2.4008]],

        [[ 2.2002,  2.9341, -0.1208, -0.9142, -2.3932],
         [ 2.2002,  2.9341, -0.1208, -0.9142, -2.3932]],

        [[ 2.2050,  2.9355, -0.1205, -0.9278, -2.3861],
         [ 2.2050,  2.9355, -0.1205, -0.9278, -2.3861]],

        [[ 2.2094,  2.9369, -0.1202, -0.9407, -2.3794],
         [ 2.2094,  2.9369, -0.1202, -0.9407, -2.3794]],

        [[ 2.2134,  2.9384, -0.1200, -0.9528, -2.3731],
         [ 2.2134,  2.9384, -0.1200, -0.9528, -2.3731]],

        [[ 2.2171,  2.9400, -0.1197, -0.9642, -2.3672],
         [ 2.2171,  2.9400, -0.1197, -0.9642, -2.3672]],

        [[ 2.2204,  2.9417, -0.1194, -0.9749, -2.3617],
         [ 2.2204,  2.9417, -0.1194, -0.9749, -2.3617]],

        [[ 2.2233,  2.9435, -0.1191, -0.9851, -2.3566],
         [ 2.2233,  2.9435, -0.1191, -0.9851, -2.3566]],

        [[ 2.2258,  2.9454, -0.1187, -0.9946, -2.3519],
         [ 2.2258,  2.9454, -0.1187, -0.9946, -2.3519]],

        [[ 2.2280,  2.9475, -0.1182, -1.0035, -2.3476],
         [ 2.2280,  2.9475, -0.1182, -1.0035, -2.3476]],

        [[ 2.2297,  2.9497, -0.1176, -1.0120, -2.3437],
         [ 2.2297,  2.9497, -0.1176, -1.0120, -2.3437]],

        [[ 2.2310,  2.9520, -0.1170, -1.0199, -2.3401],
         [ 2.2310,  2.9520, -0.1170, -1.0199, -2.3401]],

        [[ 2.2320,  2.9545, -0.1162, -1.0273, -2.3368],
         [ 2.2320,  2.9545, -0.1162, -1.0273, -2.3368]],

        [[ 2.2325,  2.9571, -0.1153, -1.0343, -2.3338],
         [ 2.2325,  2.9571, -0.1153, -1.0343, -2.3338]]]),
        
        torch.tensor([[[ 0.9160,  3.1813, -1.0949, -0.2333, -1.0630],
         [ 0.9160,  3.1813, -1.0949, -0.2333, -1.0630]]]),
        ...
        cls.enc_output_forprediction_hidden_states = [torch.tensor([[[ 1.3950,  1.2677,  0.3756,  0.0789, -1.4111],
         [ 1.3950,  1.2677,  0.3756,  0.0789, -1.4111]],
        ...
        [[ 1.5856,  1.9463,  0.3495, -1.2532,  0.3535],
         [ 1.5856,  1.9463,  0.3495, -1.2532,  0.3535]],

        [[ 1.5876,  1.9456,  0.3452, -1.2520,  0.3552],
         [ 1.5876,  1.9456,  0.3452, -1.2520,  0.3552]],

        [[ 1.5891,  1.9450,  0.3410, -1.2506,  0.3573],
         [ 1.5891,  1.9450,  0.3410, -1.2506,  0.3573]],

        [[ 1.5900,  1.9445,  0.3368, -1.2493,  0.3597],
         [ 1.5900,  1.9445,  0.3368, -1.2493,  0.3597]],

        [[ 1.5904,  1.9441,  0.3327, -1.2479,  0.3625],
         [ 1.5904,  1.9441,  0.3327, -1.2479,  0.3625]],

        [[ 1.5903,  1.9437,  0.3288, -1.2465,  0.3655],
         [ 1.5903,  1.9437,  0.3288, -1.2465,  0.3655]],

        [[ 1.5897,  1.9434,  0.3250, -1.2451,  0.3687],
         [ 1.5897,  1.9434,  0.3250, -1.2451,  0.3687]]]),
        ...
        [[ 2.1775,  2.9291, -0.1231, -0.8510, -2.4263],
         [ 2.1775,  2.9291, -0.1231, -0.8510, -2.4263]],
        ...
        [[ 2.4992,  3.3195, -0.3906, -2.5442,  0.0979],
         [ 2.4992,  3.3195, -0.3906, -2.5442,  0.0979]],

        [[ 2.5058,  3.3152, -0.3979, -2.5420,  0.1007],
         [ 2.5058,  3.3152, -0.3979, -2.5420,  0.1007]],

        [[ 2.5118,  3.3107, -0.4048, -2.5403,  0.1043],
         [ 2.5118,  3.3107, -0.4048, -2.5403,  0.1043]],

        [[ 2.5174,  3.3060, -0.4112, -2.5391,  0.1087],
         [ 2.5174,  3.3060, -0.4112, -2.5391,  0.1087]],

        [[ 2.5223,  3.3011, -0.4171, -2.5385,  0.1139],
         [ 2.5223,  3.3011, -0.4171, -2.5385,  0.1139]],

        [[ 2.5267,  3.2962, -0.4225, -2.5384,  0.1198],
         [ 2.5267,  3.2962, -0.4225, -2.5384,  0.1198]],

        [[ 2.5304,  3.2911, -0.4273, -2.5389,  0.1264],
         [ 2.5304,  3.2911, -0.4273, -2.5389,  0.1264]]]),
        
        torch.tensor([[[ 0.9559,  3.1517, -1.1341, -0.2454, -1.0221],
         [ 0.9559,  3.1517, -1.1341, -0.2454, -1.0221]],

        [[ 1.7673,  3.5491, -1.5643, -0.8036,  0.0332],
         [ 1.7673,  3.5491, -1.5643, -0.8036,  0.0332]],

        [[ 1.7825,  3.5710, -1.6063, -0.8246,  0.0592],
         [ 1.7825,  3.5710, -1.6063, -0.8246,  0.0592]],

        [[ 1.7993,  3.5916, -1.6465, -0.8459,  0.0832],
         [ 1.7993,  3.5916, -1.6465, -0.8459,  0.0832]],

        [[ 1.8173,  3.6104, -1.6838, -0.8666,  0.1045],
         [ 1.8173,  3.6104, -1.6838, -0.8666,  0.1045]],

        [[ 1.8359,  3.6270, -1.7176, -0.8859,  0.1224],
         [ 1.8359,  3.6270, -1.7176, -0.8859,  0.1224]],

        [[ 1.8547,  3.6412, -1.7474, -0.9033,  0.1366],
         [ 1.8547,  3.6412, -1.7474, -0.9033,  0.1366]],

        [[ 1.8731,  3.6527, -1.7728, -0.9183,  0.1470],
         [ 1.8731,  3.6527, -1.7728, -0.9183,  0.1470]]]),
        ]
        ...
        #     cls.params["encoder_state_dim"],
        # )
        cls.enc_output_last_hidden_state = torch.tensor([[[ 0.9160,  3.1813, -1.0949, -0.2333, -1.0630],
         [ 0.9160,  3.1813, -1.0949, -0.2333, -1.0630]]])
        ...
        #     cls.params["encoder_state_dim"],
        # )
        cls.enc_output_forprediction_last_hidden_state = torch.tensor([[[ 0.9559,  3.1517, -1.1341, -0.2454, -1.0221],
         [ 0.9559,  3.1517, -1.1341, -0.2454, -1.0221]],
        ...
        #     cls.params["num_input_channels"],
        # )
        cls.dec_output_last_hidden_state = torch.tensor([[[[[ 0.1641],
           [-0.1768],
           [-0.3237],
           [-0.4347],
           [-0.1106]],
        ...
        #     cls.params["num_input_channels"],
        # )
        cls.dec_output_forprediction_last_hidden_state = torch.tensor([[[[[ 0.1605],
           [-0.1805],
           [-0.3208],
           [-0.4351],
           [-0.1164]],
        ...
        # ) for _ in range(1)]
        cls.dec_output_hidden_states = [torch.tensor([[[[-0.9459, -0.5805, -0.2807,  1.8970, -0.9403,  1.2147],
        ...
        #     cls.params["decoder_dim"]
        # ) for _ in range(1)]
        cls.dec_output_forprediction_hidden_states = [torch.tensor([[[[-0.9527, -0.5823, -0.2907,  1.8720, -0.9327,  1.2355],
        ...
        #     cls.params["num_input_channels"],
        # )
        cls.correct_pred_output = torch.tensor([[[[[1.0005],
           [0.9994],
           [0.9990],
           [0.9986],
           [0.9997]],
        ...
        #     cls.params["num_input_channels"],
        # )
        cls.correct_forecast_output = torch.tensor([[[[1.0005],
          [0.9994],
          [0.9990],
          [0.9986],
          [0.9996],
    ...
    def check_module(
        ...
        if task == "forecast":
            if not (config.use_return_dict and isinstance(output, FlowStateForPredictionOutput)) and not (not config.return_dict and isinstance(output, tuple)):
                raise Exception('Return type of the model was incorrect!')
        elif task == "model":
            if not (config.use_return_dict and isinstance(output, FlowStateModelOutput)) and not (not config.return_dict and isinstance(output, tuple)):
                raise Exception('Return type of the model was incorrect!')
        else:
            pass
        ...
        if not config.return_dict and task == "forecast":
            output = FlowStateForPredictionOutput(loss=output[0],
            ...
            output = FlowStateModelOutput(last_hidden_state=output[0],
        ...
        [compare(out, tar, msg="The hidden states of the encoder are different!") for out, tar in zip(output.hidden_states[:-1], enc_output_hidden_states)]
        [compare(out, tar, msg="The hidden states of the decoder are different!") for out, tar in zip(output.hidden_states[-1:], dec_output_hidden_states)]
        ...
        if task == "forecast":
            ...
            compare(output.embedded_output, self.__class__.embed_output, msg="The output of the embedding does not match!")
    ...
    def test_checkshapesandvalues(
        ...
        input_data = self.__class__.constant_data if batch_first else torch.transpose(self.__class__.constant_data, 1, 0)
