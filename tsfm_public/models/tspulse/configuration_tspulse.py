...
class TSPulseConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        fft_weight: Optional[float] = 1,
        fft_prob_weight: Optional[float] = 1,
        fft_prob_length: Optional[int] = None,
        fft_prob_mode: Optional[str] = "plain",
        enable_fft_prob_loss: Optional[bool] = True,
        fft_original_signal_loss_weight: Optional[float] = 1,
        fft_time_add_forecasting_pt_loss: Optional[bool] = False,
        fft_time_add_forecasting_pt_loss_weight: Optional[float] = 1,
        ...
        head_gated_attention_activation: Optional[str] = "softmax",
